function loadUIResource(filePath)
{
	...
	switch(fileType)
	{
		case "js":
			...
			$(resource).attr("type","text/javascript");
			$(resource).attr("src", filePath);
			break;
		case "css":
			resource = document.createElement("link");
			$(resource).attr("rel", "stylesheet")
			$(resource).attr("type", "text/css")
			$(resource).attr("href", filePath)
			break;
		default:
			break;
    }
...
if(typeof jqueryuiCSS !== 'undefined')
{
	loadUIResource(jqueryuiCSS);
}
